...
parserTest = do
  ...
  it "#21" $ checkWithEval parse "((1 + (2)) + (1 + 2 + (2))) < 49 && F" $ BLit False
  it "#22" $ checkWithEval parse "((( ((1 + (2) )   ))) + (((1)) + 2 + (2))) < 49 && F" $ BLit False
